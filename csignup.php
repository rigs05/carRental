<!-- calling required file for customer signup operations -->
<?php
    require_once 'controllers/_customerSignup.php'
?>
...
<body>
    ...
    <!-- showing alerts for signup successful or errors -->
    <?php
    if ($showAlert) {
        echo
    ...
    <div class="container container-fluid">
        <h2 class="text-center m-2 p-2">Signup to our Website</h2>
        <form action="csignup.php" method="post" class="mt-4 d-grid justify-content-center">
